          ...
          <CardContent className="p-3 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <h3 className={`text-lg font-medium ${themeClasses.text.primary}`}>Add Labor</h3>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <h3 className={`text-lg font-medium ${themeClasses.text.primary}`}>Add Equipment</h3>
                <div className="flex gap-2">
                  <Button 
                    variant="outline" 
                    size="sm" 
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <h3 className={`text-lg font-medium ${themeClasses.text.primary}`}>Add Other</h3>
                <div className="flex gap-2">
                  <Button 
                    variant="outline" 
                    size="sm" 
